...
import { IActiveTasksFilterValues, IFilterValues } from 'features/filter/types';
...
export const ActiveTasksFilter = () => {
  ...
  const [filterValues, setFilterValues] = useState<IActiveTasksFilterValues>({
    sortBy: '',
    categories: [],
    searchRadius: '',
  });
  ...
  const setFilterState = (value: IFilterValues) => {
    setFilterValues(value as IActiveTasksFilterValues);
  };
